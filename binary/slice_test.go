...
func TestMakeSlice(t *testing.T) {
	...
	tests := []struct {
		...
		{"[]float64", args{gltf.ComponentFloat, gltf.AccessorScalar, 5}, make([]float64, 5)},
		// Vec2
		...
		{"[][2]float64", args{gltf.ComponentFloat, gltf.AccessorVec2, 5}, make([][2]float64, 5)},
		// Vec3
		...
		{"[][3]float64", args{gltf.ComponentFloat, gltf.AccessorVec3, 5}, make([][3]float64, 5)},
		// Vec4
		...
		{"[][4]float64", args{gltf.ComponentFloat, gltf.AccessorVec4, 5}, make([][4]float64, 5)},
		// Mat2
		...
		{"[][2][2]float64", args{gltf.ComponentFloat, gltf.AccessorMat2, 5}, make([][2][2]float64, 5)},
		// Mat3
		...
		{"[][3][3]float64", args{gltf.ComponentFloat, gltf.AccessorMat3, 5}, make([][3][3]float64, 5)},
		// Mat4
		...
		{"[][4][4]float64", args{gltf.ComponentFloat, gltf.AccessorMat4, 5}, make([][4][4]float64, 5)},
	}
